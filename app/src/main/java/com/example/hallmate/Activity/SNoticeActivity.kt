...
import com.example.hallmate.databinding.ActivitySnoticeBinding
...
class SNoticeActivity : AppCompatActivity() {

    lateinit var binding: ActivitySnoticeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivitySnoticeBinding.inflate(layoutInflater)
    ...
    private fun showPicture() {
        ...
        databaseRef.limitToLast(10).addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                load.end()
                Toast.makeText(this@SNoticeActivity, "Failed to load images", Toast.LENGTH_SHORT).show()
            }
        })
        load.end()
